...
public class CGVReserveDto implements Serializable {
	...
	public CGVReserveDto(String runningTime, String movieDate, String selectedLocation, String selectedTheater) {
		super();
	...
	public String toString() {
		return "CGVReserveDto [id=" + id + ", reserveSequence=" + reserveSequence + ", title=" + title
				...
				+ ", ticketNumber=" + ticketNumber + ", selectedSeat=" + selectedSeat + ",selectedLocation=" + selectedLocation +", selectedTheater="
				+ selectedTheater + ", movieAge=" + movieAge + "]";
	}
	
	
	//0905 장, 추가 (toString에도 추가)
