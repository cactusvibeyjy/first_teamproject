...
//		this.seq = seq;
	...
	/*
	 * @Override public String toString() { return "CGVInfoDto [rank=" + rank +
	 * ", img=" + img + ", movieAge=" + movieAge + ", movieTitle=" + movieTitle +
	 * ", movieRate=" + movieRate + ", movieOpenDate=" + movieOpenDate + ", like=" +
	 * like + ", seq=" + seq + "]"; }
	 */
