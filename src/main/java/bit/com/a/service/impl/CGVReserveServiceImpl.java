...
public class CGVReserveServiceImpl implements CGVReserveService {
	...
	public boolean modifyMovie(CGVReserveDto dto) {
		return cgvReserveDao.modifyMovie(dto);
	}

	@Override
	public boolean deleteMovie(int id) {
		return cgvReserveDao.deleteMovie(id);
	}

	@Override
	public void deleteMoviePay(int reserveSeq) {
		cgvReserveDao.deleteMoviePay(reserveSeq);
		
	}

	@Override
	public CGVReserveDto getReserveMovie(CGVReserveDto reserveDto) {
		return cgvReserveDao.getReserveMovie(reserveDto);
	}
	@Override
	public List<CGVReserveDto> getReserveSeats(CGVReserveDto dto){
		List<CGVReserveDto> list = new ArrayList<CGVReserveDto>();
		 list = cgvReserveDao.getReserveSeats(dto);
		return list;
	}
}
