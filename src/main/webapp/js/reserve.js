...
const theaterLocation = document.querySelectorAll('.theater-location'); //0905 장, 추가
...
// 0905 장, theaterLocation eventListener 메서드 추가
...
// 0905 장, selectedLocation 관련 1줄 추가
moveSeatButton.addEventListener('click', function() {
    if (!!inputTitle.value &&
    	!!inputSelectedLocation.value &&
