...
const moveNoMember = document.querySelector('.moveNoMember');
const guestReserve = document.querySelector('.guestReserve');
...
// 비회원 예매 홈페이지로 이동
moveNoMember.addEventListener('click', () => {
    location.href = 'moveNoMember.do';
});
