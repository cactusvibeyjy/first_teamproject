...
<jsp:include page="header.jsp" />
	<%
		if (login == null && reserve.getId() == null) {
	%>
	<script>
			...
			<div class="select-seat-container">
				...
				<div class="select-seat-information">
					...
					<div class="select-seat-information-wrapper">
						<!-- 0905 장, 수정 -->
						<div class="select-theater-location selected-theater-location-info"><%=reserve.getSelectedLocation()%></div>
					...
					<form action="moveKakao.do" class="seatForm" method="post">
				        <input type="hidden" class="id" name="id" value="${reserve.getId()}">
